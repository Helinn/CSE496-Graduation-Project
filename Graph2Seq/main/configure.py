train_data_path = "./Graph2Seq/data/no_cycle/train.data"
dev_data_path = "./Graph2Seq/data/no_cycle/dev.data"
test_data_path = "./Graph2Seq/data/no_cycle/test.data"

word_idx_file_path = "./Graph2Seq/data/word.idx"
